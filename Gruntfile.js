// Generated on 2015-09-15 using generator-angular-fullstack 2.0.13
'use strict';
  ...
  grunt.initConfig({
    ...
    wiredep: {
      target: {
        ...
        exclude: [/bootstrap-sass-official/, /bootstrap.js/, '/json3/', '/es5-shim/', /bootstrap.css/, /font-awesome.css/, /flag-icon-css/ ]
      }
    },
    ...
    buildcontrol: {
      ...
      heroku: {
        options: {
          remote: 'git@heroku.com:pharmaplus.git',
          branch: 'master'
        }
      },
      openshift: {
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
              ['{.tmp,<%= yeoman.client %>}/{app,components}/**/*.js',
               ...
               '!{.tmp,<%= yeoman.client %>}/app/DYMO.Label.Frameork_2.0Beta.js',
               '!{.tmp,<%= yeoman.client %>}/{app,components}/**/*.spec.js',
               '!{.tmp,<%= yeoman.client %>}/{app,components}/**/*.mock.js']
            ]
        }
